...
public class EllipseAndRectanglePanel extends JPanel {
    ...
    private static final long serialVersionUID = 8590889187962361914L;
    ...
    public void paintComponent(final Graphics theGraphics) {
        ...
        g2d.setStroke(new BasicStroke(25, BasicStroke.CAP_BUTT,
        ...
        g2d.setPaint(new Color(0, 0, 255, 125));
        g2d.fill(ellipse2);
